...
In early 2022 I wrote the story of an investigation into the performance degradation of Square's fork of the Android OS (Squid): "Diary of a Slow Squid" (learn more in [this public talk](https://youtu.be/kOH1Kdj9c1c?si=bykCD_r8Yxzn7u-b&t=1626)).
...
![Terminal API](/images/terminal-api.png)
